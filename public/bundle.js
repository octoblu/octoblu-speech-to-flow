...
/***/ function(module, exports, __webpack_require__) {
	...
	var App, React, Speech;

	React = __webpack_require__(2);

	Speech = __webpack_require__(1);

	App = React.createClass({
	  displayName: 'HelloWorld',
	  render: function() {
	    return React.createElement("div", null, React.createElement(Speech, null));
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	Speech = React.createClass({
	  ...
	  componentWillMount: function() {
	    ...
	    return this.recognition = new webkitSpeechRecognition();
	  },
	  componentDidMount: function() {
	    console.log('Did Mount...');
	    return this.recognition.onresult = (function(_this) {
	      return function(recordingEvent) {
	        _this.setState({
	          recording: false
	        });
	        return _this.setState({
	          result: recordingEvent.results[0][0].transcript
	        });
	      };
	    })(this);
	  },
	  ...
	  render: function() {
	    ...
	    }, React.createElement("h1", null, "Press the Button to begin recording...."), React.createElement("button", {
	      "onClick": this.record,
	      "disabled": this.state.recording,
	      "className": "speech__record__button"
	    }, "Record"), React.createElement("p", {
	      "className": "speech__result"
	    }, this.state.result));
	  }
	});
